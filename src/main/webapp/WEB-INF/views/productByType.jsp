...
<div id="product-list-container" class="container">
    <br>
    <h3 class="text-center">All products from category ${productsByType.get(0).productType}: </h3>
    <br>
    <h6 class="text-center">Click the zoom icon for product details or to add it to your cart</h6>
    <table class="table">
        <thead>
        <tr>
            <th>Photo</th>
        ...
        <tbody>
        <c:forEach items="${productsByType}" var="product">
            <tr id="table-row">
